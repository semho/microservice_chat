...
func (c *chatServerV1Client) DeleteChat(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedChatServerV1Server) DeleteChat(context.Context, *DeleteRequest) (*emptypb.Empty, error) {
...
func _ChatServerV1_DeleteChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServerV1Server).DeleteChat(ctx, req.(*DeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
